...
import type { GuessStore, PlayerStore, RoomStore, RoundStore } from "@/types/game";

function createGuess(playerNumber: number, guessNumeric: number): GuessStore {
...
describe("serializeHostState", () => {
  it("defaults missing stored pointsAwarded values to zero", () => {
    ...
    delete (legacyGuess as Partial<GuessStore>).pointsAwarded;
